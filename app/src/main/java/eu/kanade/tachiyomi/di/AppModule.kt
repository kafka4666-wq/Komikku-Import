...
class AppModule(val app: Application) : InjektModule {
    ...
    override fun InjektRegistrar.registerInjectables() {
        // Injekt resolves exact Kotlin types. Application is a Context, but it is not a
        // registration for callers requesting android.content.Context after process recreation.
        addSingleton(app)
        addSingleton<Context>(app)
        addSingletonFactory<KomikkuCustomisationPreferences> {
            KomikkuCustomisationPreferences(get())
        }
        addSingletonFactory<DoujinCustomisationsPreferences> {
            DoujinCustomisationsPreferences(get())
        }
