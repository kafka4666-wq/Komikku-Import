...
class NotificationReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        when (intent.action) {
            ...
            ACTION_PAUSE_BATCH_IMPORT -> BatchImportJob.pause(context)
            ACTION_RESUME_BATCH_IMPORT -> BatchImportJob.resume(context)
    ...
    companion object {
        ...
        internal fun pauseBatchImportPendingBroadcast(context: Context): PendingIntent =
            batchImportPendingBroadcast(context, ACTION_PAUSE_BATCH_IMPORT, 9001)

        internal fun resumeBatchImportPendingBroadcast(context: Context): PendingIntent =
            batchImportPendingBroadcast(context, ACTION_RESUME_BATCH_IMPORT, 9002)
