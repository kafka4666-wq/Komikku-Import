...
class PagerConfig(
    ...
    init {
        val doujinPreferences = DoujinCustomisationsPreferences(Injekt.get<PreferenceStore>())
        usePageTransitions = doujinPreferences.animations().get() &&
            doujinPreferences.pageTransitions().get() != "instant" &&
            doujinPreferences.readerAnimation().get() != "instant"
