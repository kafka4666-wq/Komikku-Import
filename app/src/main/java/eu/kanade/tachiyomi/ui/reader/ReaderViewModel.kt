...
//                // KMK <--
    ...
    /**
     * Restart the current chapter from its first page without changing the persisted read state.
     * This is used by the optional Komikku resume prompt.
     */
    fun restartCurrentChapterFromBeginning() {
        val currentChapters = state.value.viewerChapters ?: return
        currentChapters.currChapter.requestedPage = 0
        viewModelScope.launchIO {
